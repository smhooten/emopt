...
y_pts = Y/2 + np.array([wg_spacing/2+w_wg,
                  wg_spacing/2+w_wg,
                  w_wg_out/2,
                  w_wg_out/2,
                  -w_wg_out/2,
