...
# Ridge spacer
wg_in_top_spacer = emopt.grid.Rectangle(L_in2/2, Y/2+wg_spacing/2+w_wg2/2,
                                        L_in2, w_wg2)
wg_in_top_spacer.layer = 1; wg_in_top_spacer.material_value = n_SiO2**2

wg_in_bottom_spacer = emopt.grid.Rectangle(X/2, Y/2-wg_spacing/2-w_wg/2, L_in,
                                           w_wg)
...
# Ridge waveguide
wg_in_top_waveguide = emopt.grid.Rectangle(L_in2/2, Y/2+wg_spacing/2+w_wg2/2,
                                           L_in2, w_wg2)
...
# Ridge lower
wg_in_top_lower = emopt.grid.Rectangle(X/2, Y/2+wg_spacing/2+w_wg2/2, L_in2,
                                       w_wg2)
wg_in_top_lower.layer = 1; wg_in_top_lower.material_value = n_SiO2**2

wg_in_bottom_lower = emopt.grid.Rectangle(L_in/2, Y/2-wg_spacing/2-w_wg/2,
                                          L_in, w_wg)
