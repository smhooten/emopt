...
class SpatialMuxAdjointMethod(AdjointMethod):
    ...
    def __init__(self, sim, spacer, waveguide, lower, indices, xs, ys, ZminD,
        ...
        super(SpatialMuxAdjointMethod, self).__init__(sim, step=1e-5)
        self.spacer = spacer
...
class SpatialMux(object):
    def __init__(self, wavelength):
        ...
        inds_intra = [False, True, False,  True, False, True, True, True, True, False]
        inds_inter = [False, True, True, True, True, True, True, True, True, True]
