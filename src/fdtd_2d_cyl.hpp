...
#ifndef __FDTD_TE_HPP__
#define __FDTD_TE_HPP__
...
namespace fdtd_2d_cyl {
    ...
    */
    ...
    typedef struct struct_SourceArray_TM {
        complex128 *Jp, *Jz, *Mo;
        int j0, k0, J, K;
    } SourceArray_TM;
    ...
    class FDTD_TE {
        private:
            ...
            // number of Yee cells in X, Y
            int _Np, _Nz;

            // size and location of local chunk in grid
            int _J, _K, _j0, _k0;

            // physical simulation size and Yee cell size in x,y
            double _P, _Z, _dp, _dz;
            ...
            std::vector<SourceArray_TE> _sources;
        ...
        public:
             ...
             */
            void set_physical_dims(double X, double Y,
                                         double dx, double dy);
             ...
             */
            void set_grid_dims(int Nx, int Ny);
             ...
             */
            void set_local_grid(int k0, int j0, int K, int J);
             ...
             */
            void set_field_arrays(double *Ez,
                                  double *Hx, double *Hy);
             ...
             */
            void set_mat_arrays(complex128 *eps_z,
             ...
             */
            void set_pml_widths(int xmin, int xmax, int ymin, int ymax);
             ...
             */
            void set_t0_arrays(complex128 *Ez_t0,
             ...
             * These are used to calculate the amplitude and phase of the field.
             */
            void set_t1_arrays(complex128 *Ez_t1,
...
extern "C" {
        fdtd_2d_cyl::FDTD_TE* FDTD_TE_new();


        void FDTD_TE_set_wavelength(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double wavelength);
        void FDTD_TE_set_physical_dims(fdtd_2d_cyl::FDTD_TE* fdtd_TE, 
                                    double X, double Y,
                                    double dx, double dy);
        void FDTD_TE_set_grid_dims(fdtd_2d_cyl::FDTD_TE* fdtd_TE, int Nx, int Ny);
        void FDTD_TE_set_local_grid(fdtd_2d_cyl::FDTD_TE* fdtd_TE, 
                                 int k0, int j0,
                                 int K, int J);
        void FDTD_TE_set_dt(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double dt);
        void FDTD_TE_set_complex_eps(fdtd_2d_cyl::FDTD_TE* fdtd_TE, bool complex_eps);
        void FDTD_TE_set_field_arrays(fdtd_2d_cyl::FDTD_TE* fdtd_TE,
                                   double *Ez,
                                   double *Hx, double *Hy);

        void FDTD_TE_set_mat_arrays(fdtd_2d_cyl::FDTD_TE* fdtd_TE,
                                 complex128 *eps_z,
                                 complex128 *mu_x, complex128 *mu_y);

        void FDTD_TE_update_H(fdtd_2d_cyl::FDTD_TE* fdtd_TE, int n, double t);
        void FDTD_TE_update_E(fdtd_2d_cyl::FDTD_TE* fdtd_TE, int n, double t);

        // Pml management
        void FDTD_TE_set_pml_widths(fdtd_2d_cyl::FDTD_TE* fdtd_TE, int xmin, int xmax,
                                                   int ymin, int ymax);
        void FDTD_TE_set_pml_properties(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double sigma, double alpha,
                                                       double kappa, double pow);
        void FDTD_TE_build_pml(fdtd_2d_cyl::FDTD_TE* fdtd_TE);
        void FDTD_TE_reset_pml(fdtd_2d_cyl::FDTD_TE* fdtd_TE);

        // auxillary array management
        void FDTD_TE_set_t0_arrays(fdtd_2d_cyl::FDTD_TE* fdtd_TE,
                                 complex128 *Ez_t0,
                                 complex128 *Hx_t0, complex128 *Hy_t0);
        void FDTD_TE_set_t1_arrays(fdtd_2d_cyl::FDTD_TE* fdtd_TE,
                                 complex128 *Ez_t1,
                                 complex128 *Hx_t1, complex128 *Hy_t1);
        ...
        void FDTD_TE_capture_t0_fields(fdtd_2d_cyl::FDTD_TE* fdtd_TE);
        void FDTD_TE_capture_t1_fields(fdtd_2d_cyl::FDTD_TE* fdtd_TE);
        void FDTD_TE_calc_complex_fields_2T(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double t0, double t1);
        void FDTD_TE_calc_complex_fields_3T(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double t0, double t1, double t2);

        // Source management
        void FDTD_TE_add_source(fdtd_2d_cyl::FDTD_TE* fdtd_TE,
                             complex128 *Jz,
                             complex128 *Mx, complex128 *My,
                             int j0, int k0, int J, int K,
                             bool calc_phase);
        void FDTD_TE_clear_sources(fdtd_2d_cyl::FDTD_TE* fdtd_TE);

        void FDTD_TE_set_source_properties(fdtd_2d_cyl::FDTD_TE* fdtd_TE, double src_T, double src_min);

        double FDTD_TE_src_func_t(fdtd_2d_cyl::FDTD_TE* fdtd_TE, int n, double t, double phase);

        // boundary conditions
        void FDTD_TE_set_bc(fdtd_2d_cyl::FDTD_TE* fdtd_TE, char* newbc);
